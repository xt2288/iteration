...
```{r}
nsduh_html = "http://samhda.s3-us-gov-west-1.amazonaws.com/s3fs-public/field-uploads/2k15StateFiles/NSDUHsaeShortTermCHG2015.htm"
...
nsduh_df = 
  ...
  mutate(table = map(number, nsduh_html, html = nsduh_html)) |>
  unnest(table)
...
fit a lienar regression for central park
